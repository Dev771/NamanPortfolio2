    ...
    return (
        <div className={styles.hero}>
            <div>
                ...
                <div className='mt-11 text-xs'>I have worked with</div>
                ...
                <div className='flex gap-5 items-center my-8'>
                    <button className='bg-screenWhite text-[#09090B] font-bold text-base px-5 py-2 rounded-full flex gap-2 items-center'>Resume <img src={Download} alt='download' /></button>
                    { socials.map((a) => (
                        <a href={a.link} className='bg-[#27272A] aspect-square w-[40px] flex justify-center items-center rounded-full p-2'><img src={a.icon} alt={a.name} /></a>
                    ))}
                </div>
            </div>
        </div>
